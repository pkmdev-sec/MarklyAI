    ...
    struct Style {
        ...
        static var `default`: Style {
            return Style(
                ...
                titleColor: NSColor.labelColor.withAlphaComponent(0.8),
                handleTintColor: NSColor.labelColor.withAlphaComponent(0.4),
                colorSquareBorderColor: NSColor.separatorColor,
                deleteTintColor: NSColor.labelColor.withAlphaComponent(0.5),
                hoverBackgroundColor: NSColor.labelColor.withAlphaComponent(0.1),
