...
private final class RecorderBoxView: BaseView {
    ...
    private func setupUI() {
        ...
        shortcutLabel.textColor = NSColor.labelColor.withAlphaComponent(ThemeConstants.Opacity.high)
        ...
        clearButton.contentTintColor = NSColor.labelColor.withAlphaComponent(ThemeConstants.Opacity.low)
    ...
    override func handleHoverStateChanged() {
        if !isRecording {
            layer?.backgroundColor = NSColor.labelColor.withAlphaComponent(isHovered ? 0.12 : 0.08).cgColor
        }
    }
}
