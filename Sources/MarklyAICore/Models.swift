...
struct Workspace: Codable, Identifiable, Equatable {
    ...
    init(id: UUID, name: String, colorId: WorkspaceColorId, items: [Node], pinnedLinks: [Link] = [], isReadingList: Bool = false) {
        self.id = id
        self.name = name
    ...
    init(from decoder: Decoder) throws {
        ...
        isReadingList = try container.decodeIfPresent(Bool.self, forKey: .isReadingList) ?? false
    }
}
...
struct Link: Codable, Identifiable, Equatable, Sendable {
    ...
    init(id: UUID, title: String, url: String, faviconPath: String?, createdAt: Date = Date(), lastOpened: Date? = nil, tags: [String] = []) {
        self.id = id
        self.title = title
        self.url = url
