...
/// Centralized design system constants for MarklyAI.
///
...
struct ThemeConstants {
    ...
    struct Colors {
        /// Primary color for text, icons, and UI elements.
        /// Adapts to light/dark mode automatically.
        static let darkGray = NSColor.labelColor

        /// Color for light text and icons on dark backgrounds.
        /// Uses white in light mode, adapts appropriately in dark mode.
        static let white = NSColor.white

        /// Background color for settings and preferences views.
        /// Adapts to system appearance.
        static let settingsBackground = NSColor.controlBackgroundColor
    }
