...
4. **Publish the update feed**:
   ...
   ```
   GitHub Pages serves the appcast at `https://raw.githubusercontent.com/pkmdev-sec/MarklyAI/main/docs/appcast.xml`.
...
1. **Appcast feed**: `docs/appcast.xml` is hosted via GitHub Pages at `https://raw.githubusercontent.com/pkmdev-sec/MarklyAI/main/docs/appcast.xml`
